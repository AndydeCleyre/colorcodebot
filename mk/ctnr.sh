...
iosevka_pkg='https://github.com/AndydeCleyre/archbuilder_iosevka/releases/download/ccb-14-fixedvars/ttf-iosevka-term-custom-git-1645274693-1-any.pkg.tar.zst'
today=$(date +%Y.%j)
tz="America/New_York"

base_img='docker.io/library/archlinux:base'
pkgs='cairo fontconfig ghostscript graphicsmagick highlight pango python sops ttf-joypixels ttf-nerd-fonts-symbols-mono'
